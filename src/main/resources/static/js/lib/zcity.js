            ...
            var countryCityPlug = {
                render: function () {
                    ...
                    $('.js-tab-city').on('click', function () {
                        ...
                        $('.js-city-covers').html('<div id="ajaxfeed-loading" style="text-align: center;"><img src="./image/common/page_loading.gif"></div>');
                        if(flag){
                            flag = false;
                            $.ajax({
                                type: "GET",
                                url: "./js/lib/zgetAll.json",
                                dataType: "json",
                                success: function (data) {
                                    ...
                                    hotCity = "";
                                    // citySelected = $("input[name=city-radio]:checked").attr('value');
                                    ...
                                    window.renderCity = function() {
                                        ...
                                        str += "<div class=\"border-top city-content js-china\"><section class=\"left city-province-list\">" +
                                            ...
                                            "<dl class=\"\">" +
                                            "<dd class=\"\"><a data-code=\"0\" class=\"active\">热门城市</a></dd>";
                                        if (citySelected == "cn") {
                                            // 中国省级渲染
                                            
                                            $.each(cinProvince, function (index,cinProvinceinit) {
                                                str += "<dd><a data-code=\"" + cinProvinceinit.id + "\">" + cinProvinceinit.name + "</a></dd>";
                                            })
                                        } else {
                                            // 全国州、国家渲染
                                            $.each(allCountry, function (index, allCountryItem) {
                                                str += "<dt data-code=\"" + allCountryItem.id + "\">" + allCountryItem.name + "</dt>";
                                                if (allCountryItem.children.length) {
                                                    // 国家级countryChildren；
                                                    $.each(allCountryItem.children, function (index, countryChildren) {
                                                        str += "<dd ><a data-code=\"" + countryChildren.id + "\">" + countryChildren.name + "</a></dd>";
                                                    })
                                                }
                                            })
                                        }
                                                ...
                                                if (citySelected == "cn") {
                                                        ...
                                                        if (cinProvinceItem.children) {
                                                            $.each(cinProvinceItem.children, function (index, cinCityItem) {
                                                                if (cinCityItem.pid == provinceid) {
                                                                    str += "<div class=\"city-children3\"><a data-code=\"" + cinCityItem.id + "\">" + cinCityItem.name + "</a></div>";
                                                                    isexitId = true;
                                                                }
                                                            })
                                                        }
                                                    ...
                                                    if(!isexitId){
                                                        $.each(hotCity, function (index, hotCityItem) {
                                                            str += "<div class=\"city-children3\"><a data-code=\"" + hotCityItem.id + "\">" + hotCityItem.name + "</a></div>";
                                                        })
                                                        provinceid = 0;
                                                    }
                                                } else {
                                                                    ...
                                                                    $.each(eval(countryChildren2.children), function (index, countryChildren3) {
                                                                        ...
                                                                        if (eval(countryChildren3).pid == provinceid) {
                                                                            ...
                                                                            if (eval(countryChildren3).children) {
                                                                                str += "<div class=\"city-children3\" data-code=\"" + countryChildren3.id + "\"><span class=\"bbb-color\">" + countryChildren3.name + "</span>";
                                                                                str += "<ul>";
                                                                                $.each(eval(countryChildren3.children), function (index, countryChildren4) {
                                                                                    str += "<li class=\"\"><a data-code=\"" + countryChildren4.id + "\">" + countryChildren4.name + "</a></li>";
                                                                                })
                                                                                str += "</ul>";
                                                                            } else {
                                                                                str += "<div class=\"city-children3\"><a data-code=\"" + countryChildren3.id + "\">" + countryChildren3.name + "</a>";
                                                                            }
                                                                            str += "</div>";
                                                                            isexitId = true;
                                                                        }
                                    ...
                                    function bind() {
                                        $('.city-province-list dl a').on('click', function () {
                                            ...
                                            if (curId == 0) {
                                                $.each(eval(hotCity), function (index, hotCityItem) {
                                                    childrenStr += "<div class=\"city-children3\"><a data-code=\"" + hotCityItem.id + "\">" + hotCityItem.name + "</a></div>"
                                                })
                                            } else {
                                                if (citySelected == "cn") {
                                                    $.each(cinProvince, function (index, cinProvinceItem) {
                                                        if (cinProvinceItem.children) {
                                                            $.each(cinProvinceItem.children, function (index, cinCityItem) {
                                                                if (cinCityItem.pid == curId) {
                                                                    childrenStr += "<div class=\"city-children3\"><a data-code=\"" + cinCityItem.id + "\">" + cinCityItem.name + "</a></div>";
                                                                }
                                                            })
                                                        }
                                                    })
                                                                ...
                                                                if (eval(countryChildren2).children) {
                                                                    ...
                                                                    $.each(eval(countryChildren2.children), function (index, countryChildren3) {
                                                                        ...
                                                                        if (eval(countryChildren3).pid == curId) {
                                                                            ...
                                                                            // 获取最后一级省级下的市 且存在的
                                                                            if (eval(countryChildren3).children) {
                                                                                childrenStr += "<div class=\"city-children3\" data-code=\"" + countryChildren3.id + "\"><span class=\"bbb-color\">" + countryChildren3.name + "</span>";
                                                                                childrenStr += "<ul>";
                                                                                $.each(eval(countryChildren3.children), function (index, countryChildren4) {
                                                                                    childrenStr += "<li class=\"\"><a data-code=\"" + countryChildren4.id + "\">" + countryChildren4.name + "</a></li>";
                                                                                })
                                                                                childrenStr += "</ul>";
                                                                            } else {
                                                                                childrenStr += "<div class=\"city-children3\"><a data-code=\"" + countryChildren3.id + "\">" + countryChildren3.name + "</a>";
                                                                    ...
                                                                    if(countryChildren2.id == curId){
                                                                        childrenStr += "<div class=\"city-children3\"><a data-code=\"" + countryChildren2.id + "\">" + countryChildren2.name + "</a></div>"
                                                                    }
